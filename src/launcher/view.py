...
class BaseWindow(QtWidgets.QWidget):
    ...
    def initStyle(self):
        ...
        window_icon = os.path.join(current_dir, "resource", "dark.png")
...
class BaseDialog(QtWidgets.QDialog):
    ...
    def setupLauncherUI(self, cons=None, launcher_data=None):
        ...
        version_group = QtWidgets.QGroupBox(self.tr("Version Details"))
...
class BaseMessageBox(QtWidgets.QMessageBox):
    ...
    def loginMessages(self, error):
        ...
        if error is False:
            ...
            message = self.tr("Login failed, please try again...")
...
class MainWindow(BaseWindow):
    ...
    def darkTitleBar(self, hwnd=None):
        super(MainWindow, self).darkTitleBar(hwnd=hwnd)
        if hasattr(self, "launcher_lw"):
            self.launcher_lw.show()
    ...
    def addMainUI(self, parent):
        ...
        self.project_gbox = QtWidgets.QGroupBox()
        ...
        self.launcher_gbox = QtWidgets.QGroupBox()
    ...
    def addConfigUI(self, parent):
        self.command_gbox = QtWidgets.QGroupBox()
        ...
        self.console_gbox = QtWidgets.QGroupBox()
    ...
    def translateUI(self):
        self.setWindowTitle(self.tr("Launcher") + " " + os.environ.get("LAUNCHER_TAGS"))
